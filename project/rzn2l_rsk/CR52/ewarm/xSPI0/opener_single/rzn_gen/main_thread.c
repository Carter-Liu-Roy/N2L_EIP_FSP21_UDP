...
#define ETHER_BUFFER_PLACE_IN_SECTION
                ...
                static uint8_t main_thread_stack[4096] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t main_thread_stack[4096] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.main_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
...
sci_uart_instance_ctrl_t     g_uart_safety_ctrl;
            ...
            void g_uart_safety_tx_transfer_callback (transfer_callback_args_t * p_args)
            {
                FSP_PARAMETER_NOT_USED(p_args);
                sci_uart_tx_dmac_callback(&g_uart_safety_ctrl);
            }
            #endif
            ...
            void g_uart_safety_rx_transfer_callback (transfer_callback_args_t * p_args)
            {
                FSP_PARAMETER_NOT_USED(p_args);
                sci_uart_rx_dmac_callback(&g_uart_safety_ctrl);
            }
            #endif
            #undef FSP_NOT_DEFINED

            sci_baud_setting_t           g_uart_safety_baud_setting =
            {
            ...
            const sci_uart_extended_cfg_t g_uart_safety_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_1,
                .p_baud_setting         = &g_uart_safety_baud_setting,
#if 1
            ...
            const uart_cfg_t g_uart_safety_cfg =
            {
                .channel             = 3,
                .data_bits           = UART_DATA_BITS_8,
                .parity              = UART_PARITY_OFF,
                .stop_bits           = UART_STOP_BITS_1,
                .p_callback          = cip_safety_sci_callback,
                .p_context           = NULL,
                .p_extend            = &g_uart_safety_cfg_extend,
                .p_transfer_tx       = g_uart_safety_P_TRANSFER_TX,
                .p_transfer_rx       = g_uart_safety_P_TRANSFER_RX,
                .rxi_ipl             = (12),
                .txi_ipl             = (12),
                .tei_ipl             = (12),
                .eri_ipl             = (12),
...
const uart_instance_t g_uart_safety =
{
    .p_ctrl        = &g_uart_safety_ctrl,
    .p_cfg         = &g_uart_safety_cfg,
    .p_api         = &g_uart_on_sci
};
...
const ethsw_extend_cfg_t g_ethsw0_extend_cfg =
            {
    .specific_tag    = ETHSW_SPECIFIC_TAG_ENABLE,
...
#define ETHER_MAC_ADDRESS_VALID   (1)
            ...
            uint8_t g_ether0_mac_address[6] = { 0x74,0x90,0x50,0x10,0x05,0x9A };
