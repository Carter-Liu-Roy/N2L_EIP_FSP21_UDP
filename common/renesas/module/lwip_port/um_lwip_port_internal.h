...
typedef enum e_lwip_port_launcher_event
{
    ...
    LWIP_PORT_LAUNCHER_EVENT_PORT1_LINK_UP,     ///< Event when port 1 link is up
    LWIP_PORT_LAUNCHER_EVENT_PORT1_LINK_DOWN,   ///< Event when port 1 link is down
    LWIP_PORT_LAUNCHER_EVENT_PORT2_LINK_UP,     ///< Event when port 2 link is up
    LWIP_PORT_LAUNCHER_EVENT_PORT2_LINK_DOWN,   ///< Event when port 2 link is down
    LWIP_PORT_LAUNCHER_EVENT_IP_UP,       ///< Event when IP is up
    LWIP_PORT_LAUNCHER_EVENT_IP_DOWN,     ///< Event when IP is down
    LWIP_PORT_LAUNCHER_EVENT_ACD,         ///< Event when an ARP conflict detection
