...
const lwip_port_api_t g_lwip_port_on_lwip_port =
{
    ...
    .netifInfoGet    = UM_LWIP_PORT_NetifInfoGet,
    .netifAcdSet     = UM_LWIP_PORT_NetifAcdSet,
};

/*******************************************************************************************************************//**
 * @addtogroup LWIP_PORT
 * @{
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * Get netif information of lwIP network interface
 * Implements @ref lwip_port_api_t::close.
 *
 * @retval  USR_SUCCESS                  Got network information successfully.
 * @retval  USR_ERR_ABORTED              Failed to get network information
 **********************************************************************************************************************/
usr_err_t UM_LWIP_PORT_NetifInfoGet( lwip_port_ctrl_t * const p_ctrl, lwip_port_netif_info_t * p_netif_info )
{
#if defined( UM_LWIP_PORT_CFG_PARAM_CHECKING_ENABLE ) && ((1) == UM_LWIP_PORT_CFG_PARAM_CHECKING_ENABLE)
    USR_ASSERT(NULL != p_ctrl);
    USR_ASSERT(NULL != p_netif_info );
#endif
    ...
    /** Get the netif information. */
    usr_err = um_lwip_port_netif_get_netif_info( &p_instance_ctrl->netif_ctrl, p_netif_info );
    USR_ERROR_RETURN( USR_SUCCESS == usr_err, USR_ERR_ABORTED );
...
/*******************************************************************************************************************//**
 * Set netif acd enable flag of lwIP network interface
 * Implements @ref lwip_port_api_t::close.
 *
 * @retval  USR_SUCCESS                  Set network acd enable flag successfully.
 * @retval  USR_ERR_ABORTED              Failed to set network acd enable flag
 **********************************************************************************************************************/
usr_err_t UM_LWIP_PORT_NetifAcdSet( lwip_port_ctrl_t * const p_ctrl, uint8_t acd_enable )
{
#if defined( UM_LWIP_PORT_CFG_PARAM_CHECKING_ENABLE ) && ((1) == UM_LWIP_PORT_CFG_PARAM_CHECKING_ENABLE)
    USR_ASSERT(NULL != p_ctrl);
#endif
    ...
    /** Get the netif acd enable flag. */
    usr_err = um_lwip_port_netif_set_netif_acd( &p_instance_ctrl->netif_ctrl, acd_enable );
    USR_ERROR_RETURN( USR_SUCCESS == usr_err, USR_ERR_ABORTED );
