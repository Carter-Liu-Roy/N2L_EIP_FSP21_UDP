...
static usr_err_t _netif_link_port_on( lwip_port_netif_ctrl_t * p_ctrl, void * p_context );
static usr_err_t _netif_link_port_off( lwip_port_netif_ctrl_t * p_ctrl, void * p_context );
...
static void _task_code (void * pvParameter)
{
    ...
    while(true)
    {
        ...
        case LWIP_PORT_LAUNCHER_EVENT_PORT1_LINK_UP:
            usr_err = um_lwip_port_netif_list_map(p_ctrl->p_netif_list_ctrl, _netif_link_port_on, NULL);
    		if( USR_SUCCESS != usr_err)
    		{
    			/** TODO: Implement error handling in task. */
    		}
        ...
        case LWIP_PORT_LAUNCHER_EVENT_PORT1_LINK_DOWN:
        	usr_err = um_lwip_port_netif_list_map(p_ctrl->p_netif_list_ctrl, _netif_link_port_off, NULL);
    		if (USR_SUCCESS != usr_err)
    		{
    			/** TODO: Implement error handling in task. */
    		}
        ...
        case LWIP_PORT_LAUNCHER_EVENT_PORT2_LINK_UP:
            usr_err = um_lwip_port_netif_list_map(p_ctrl->p_netif_list_ctrl, _netif_link_port_on, NULL);
    		if( USR_SUCCESS != usr_err)
    		{
    			/** TODO: Implement error handling in task. */
        ...
        case LWIP_PORT_LAUNCHER_EVENT_PORT2_LINK_DOWN:
        	usr_err = um_lwip_port_netif_list_map(p_ctrl->p_netif_list_ctrl, _netif_link_port_off, NULL);
    		if (USR_SUCCESS != usr_err)
    		{
    			/** TODO: Implement error handling in task. */
        ...
        case LWIP_PORT_LAUNCHER_EVENT_ACD:
            if( request.p_netif_ctrl )
            {
                usr_err = um_lwip_port_callback_request(request.p_netif_ctrl->p_callback_ctrl, LWIP_PORT_CALLBACK_EVENT_ACD );
                if (USR_SUCCESS != usr_err)
                {
                    /** TODO: Implement error handling in task. */
                }
...
static usr_err_t _netif_link_port_on( lwip_port_netif_ctrl_t * p_ctrl, void * p_context )
{
    ...
    /** Set the network interface to up */
    usr_err = um_lwip_port_netif_set_link_up( p_ctrl );
...
static usr_err_t _netif_link_port_off( lwip_port_netif_ctrl_t * p_ctrl, void * p_context )
{
    ...
    /** Set the network interface to down */
    usr_err = um_lwip_port_netif_set_link_down( p_ctrl );
