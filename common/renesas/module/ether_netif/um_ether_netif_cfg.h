...
#define UM_ETHER_NETIF_CFG_READER_TASK_STACK_BYTE_SIZE  (2048)

#define UM_ETHER_NETIF_CFG_WRITER_TASK_NAME             ("Ethernet Writer Task")
#define UM_ETHER_NETIF_CFG_WRITER_TASK_PRIORITY         (5)
#define UM_ETHER_NETIF_CFG_WRITER_TASK_STACK_BYTE_SIZE  (2048)
...
#define UM_ETHER_NETIF_CFG_MONITOR_TASK_STACK_BTYE_SIZE (2048)
