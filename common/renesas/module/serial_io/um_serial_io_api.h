...
/*******************************************************************************************************************//**
 * @defgroup SERIAL_IO_API Serial I/O Interface
 * @ingroup RENESAS_INTERFACES
 * @brief Interface for UM_SERIAL_IO functions.
 *
 * @section SERIAL_IO_API_SUMMARY Summary
...
/** SERIAL_IO control block. Allocate an instance specific control block to pass into the SERIAL_IO API calls.
 * @par Implemented as
...
/** SERIAL_IO API structure. General net functions implemented at the HAL layer follow this API. */
