...
usr_err_t um_dlr_timer_neighbor_checker_start( dlr_neighbor_checker_ctrl_t * const p_ctrl, dlr_port_bit_t checked_port );
usr_err_t um_dlr_timer_neighbor_checker_stop( dlr_neighbor_checker_ctrl_t * const p_ctrl, dlr_port_bit_t checked_port );
usr_err_t um_dlr_timer_neighbor_checker_clear_timeout_count( dlr_neighbor_checker_ctrl_t * const p_ctrl, dlr_port_bit_t checked_port );
...
usr_err_t um_dlr_task_receiver_inform_neighbor_check_request_sequence_id( dlr_receiver_ctrl_t * const p_ctrl, dlr_port_bit_t port, uint32_t sequence_id );
