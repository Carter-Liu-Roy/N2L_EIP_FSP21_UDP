...
/** DLR events for the DLR State Machine (extended from r_ethsw driver definition) */
typedef enum e_ethsw_dlr_event_extend
{
    DLR_EVENT_LINKLOST      = ETHSW_DLR_EVENT_LINKLOST,       ///< Link was lost
    DLR_EVENT_OWNFRAME      = ETHSW_DLR_EVENT_OWNFRAME,       ///< the device received its own frame
    DLR_EVENT_LINKRESTORED  = ETHSW_DLR_EVENT_LINKRESTORED,   ///< Link is restored
    DLR_EVENT_BEACONFRAME   = ETHSW_DLR_EVENT_BEACONFRAME,    ///< Beacon Frame received
    DLR_EVENT_BEACONTIMEOUT = ETHSW_DLR_EVENT_BEACONTIMEOUT,  ///< Beacon Timer timed out
    DLR_EVENT_NEWSUPERVISOR = ETHSW_DLR_EVENT_NEWSUPERVISOR,  ///< a new Ring Supervisor was detected
    DLR_EVENT_NEWSTATE      = ETHSW_DLR_EVENT_NEWSTATE,       ///< Beacon Hardware detected new state
