 ...
 * @retval USR_ABORTED
 **********************************************************************************************************************/
usr_err_t um_dlr_fsm_send_neighbor_check_request( dlr_fsm_ctrl_t * const p_ctrl, dlr_port_bit_t const target_port )
{
	/** Error codes */
	usr_err_t usr_err;
 ...
 * @retval USR_ABORTED
 **********************************************************************************************************************/
usr_err_t um_dlr_fsm_send_neighbor_check_response( dlr_fsm_ctrl_t * const p_ctrl, dlr_event_arg_t const * const p_dlr_event, dlr_port_bit_t const target_port )
{
	/** Error codes */
	usr_err_t usr_err;
 ...
 * @retval USR_ABORTED
 **********************************************************************************************************************/
usr_err_t um_dlr_fsm_send_sign_on( dlr_fsm_ctrl_t * const p_ctrl, dlr_event_arg_t const * const p_dlr_event, dlr_port_bit_t target_port )
{
	/** Error codes */
	usr_err_t usr_err;
