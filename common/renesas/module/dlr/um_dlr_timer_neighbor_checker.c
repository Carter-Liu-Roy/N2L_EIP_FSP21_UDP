...
{
	/** Resolve Context */
	dlr_neighbor_check_timer_callback_arg_t * const p_callback_arg = ( dlr_neighbor_check_timer_callback_arg_t *) pvTimerGetTimerID( xTimer );
	dlr_neighbor_checker_ctrl_t * const p_ctrl = ( dlr_neighbor_checker_ctrl_t *) p_callback_arg->p_context;
	dlr_port_bit_t timeout_port = p_callback_arg->timedout_port;
