...
usr_err_t UM_OPENER_PORT_Start (opener_port_ctrl_t * const p_ctrl )
{
    ...
    opener_port_instance_ctrl_t * const p_instance_ctrl = (opener_port_instance_ctrl_t *) p_ctrl;
 ...
 * Implements @ref opener_port_api_t::moduleStateSet.
 *
 * @retval  USR_SUCCESS                  Process completed successfully.
 **********************************************************************************************************************/
usr_err_t UM_OPENER_PORT_SettableNvDataGet (opener_port_ctrl_t * const p_ctrl, opener_port_cip_settable_nvdata_t * const p_nvdata_cfg )
{
    ...
    /** Get Safety Supervisor object attributes. */
    usr_err = um_opener_port_tcpip_netif_get_cip_safetysupervisor_nvdata( p_nvdata_cfg->p_safetysupervisor_nvdata );
    USR_ERROR_RETURN( USR_SUCCESS == usr_err, usr_err );
#endif
