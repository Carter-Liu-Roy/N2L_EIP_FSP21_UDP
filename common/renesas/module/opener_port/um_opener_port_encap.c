...
{
    /** Resolve context */
    opener_port_encap_ctrl_t * const p_ctrl = (opener_port_encap_ctrl_t *) gp_callback_context;
    ...
    uint8_t qos_dscp_value = CipQosGetDscpPriority((ConnectionObjectPriority) qos_for_socket);
