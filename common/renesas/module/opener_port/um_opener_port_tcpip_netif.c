...
#if 0  /** It was supposed to be used in function _init_cip_qos_instance_attributes(), but is under development.
        *  Commented out until future updates.
        */
...
#endif
#if defined(OPENER_CIP_SAFETY)
static usr_err_t _init_cip_safetysupervisor_instance_attributes( opener_port_tcpip_netif_ctrl_t * const p_ctrl );
#endif
...
#if defined(OPENER_CIP_SAFETY)
    /** Initialize CIP Safety Supervisor instance attributes. */
    usr_err = _init_cip_safetysupervisor_instance_attributes( p_ctrl );
    USR_ERROR_RETURN( USR_SUCCESS == usr_err, USR_ERR_NOT_INITIALIZED );
#endif
                                                       ...
                                                       struct sockaddr * p_dst_addr)
{
    ...
    /** Packet information */
    struct in_pktinfo * p_packet_info = NULL;
                                                          ...
                                                          opener_port_cip_qos_nvdata_t * const p_cip_qos_cfg )
{
    ...
    p_cip_qos_cfg->dscp_explict   = g_qos.dscp.explicit_msg;
    p_cip_qos_cfg->dscp_high      = g_qos.dscp.high;
    p_cip_qos_cfg->dscp_low       = g_qos.dscp.low;
    p_cip_qos_cfg->dscp_scheduled = g_qos.dscp.scheduled;
    p_cip_qos_cfg->dscp_urgent    = g_qos.dscp.urgent;
...
#if defined(OPENER_CIP_SAFETY)
/*******************************************************************************************************************//**
 * @brief Get Safety Supervisor settable non-volatile configuration.
 *
 * @retval USR_SUCCESS                  Process has been done successfully.
 * @retval USR_ASSERTION                Assertion error
 **********************************************************************************************************************/
usr_err_t um_opener_port_tcpip_netif_get_cip_safetysupervisor_nvdata( opener_port_cip_safetysupervisor_nvdata_t * const p_cip_safetysupervisor_cfg )
{
    /** Check output argument pointer */
    USR_ASSERT( p_cip_safetysupervisor_cfg );

    /** Copy the values. */
    /* Password */
    memcpy(p_cip_safetysupervisor_cfg->password, g_safetysupervisor.password, sizeof(g_safetysupervisor.password));
    /* Alarm Enable */
    p_cip_safetysupervisor_cfg->alarm_enable = g_safetysupervisor.alarm_enable;
    /* Warning Enable */
    p_cip_safetysupervisor_cfg->warning_enable = g_safetysupervisor.warning_enable;
    /* Configuration Lock */
    p_cip_safetysupervisor_cfg->config_lock = g_safetysupervisor.config_lock;
    /* Configuration UNID */
    p_cip_safetysupervisor_cfg->cfunid.snn.time_of_day = g_safetysupervisor.cfunid.snn.time_of_day;
    p_cip_safetysupervisor_cfg->cfunid.snn.date = g_safetysupervisor.cfunid.snn.date;
    p_cip_safetysupervisor_cfg->cfunid.nodeid = g_safetysupervisor.cfunid.nodeid;
    /* Safety Configuration Identifier */
    p_cip_safetysupervisor_cfg->scid.sccrc = g_safetysupervisor.scid.sccrc;
    p_cip_safetysupervisor_cfg->scid.scts.time_of_day = g_safetysupervisor.scid.scts.time_of_day;
    p_cip_safetysupervisor_cfg->scid.scts.date = g_safetysupervisor.scid.scts.date;
    /* Target UNID */
    p_cip_safetysupervisor_cfg->tunid.snn.time_of_day = g_safetysupervisor.tunid.snn.time_of_day;
    p_cip_safetysupervisor_cfg->tunid.snn.date = g_safetysupervisor.tunid.snn.date;
    p_cip_safetysupervisor_cfg->tunid.nodeid = g_safetysupervisor.tunid.nodeid;
    /* Output Connection Point Owners */
    p_cip_safetysupervisor_cfg->output_connection_owners.num = g_safetysupervisor.output_connection_owners.num;
    p_cip_safetysupervisor_cfg->output_connection_owners.output_owners[0].ocpunid.snn.time_of_day = g_safetysupervisor.output_connection_owners.output_owners[0].ocpunid.snn.time_of_day;
    p_cip_safetysupervisor_cfg->output_connection_owners.output_owners[0].ocpunid.snn.date = g_safetysupervisor.output_connection_owners.output_owners[0].ocpunid.snn.date;
    p_cip_safetysupervisor_cfg->output_connection_owners.output_owners[0].ocpunid.nodeid = g_safetysupervisor.output_connection_owners.output_owners[0].ocpunid.nodeid;
    /* Config Data */
    memcpy(p_cip_safetysupervisor_cfg->config_data, g_safetysupervisor.config_data, sizeof(g_safetysupervisor.config_data));
...
#if 0   /** Ideally, the process below would substitute the current value for the configured value that was changed before the reset.
         *  However, there is a lack of an API for users to set changed values, so comment out until future updates.
         */
...
#if defined(OPENER_CIP_SAFETY)
/*******************************************************************************************************************//**
 * @brief Initialize CIP Safety Supervisor interface object instance attributes
 *
 * NOTE:
 *  This function initialize all attributes even if the attributes have already initialized on definition or on CipStackInit() function.
 *  This function should be called after the CIP stack initialization to overwrite attributes by the CIP initialization.
...
static usr_err_t _init_cip_safetysupervisor_instance_attributes( opener_port_tcpip_netif_ctrl_t * const p_ctrl )
{
    ...
    /** Start Safety Supervisor Object. */
    eip_err = CipSafetySupervisorStart();
