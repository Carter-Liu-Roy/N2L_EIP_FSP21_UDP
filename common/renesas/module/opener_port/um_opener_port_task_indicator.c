...
#if defined(OPENER_CIP_SAFETY)
#define INDICATOR_FLASHING_INTERVAL_MS        (250)
#else
...
#if defined(OPENER_CIP_SAFETY)
#define OPENER_PORT_MODULE_STATE_SAFETY_NUM (9)
#endif
...
#if defined(OPENER_CIP_SAFETY)
/**
 * Vol5 2.23 5-4.5 Safety Supervisor Behavior
 */
static const opener_port_indicator_status_t g_module_state_safety_indicator_map[OPENER_PORT_MODULE_STATE_SAFETY_NUM] =
{
    [kDeviceStatusUndefined] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_STEADY_OFF,
        .red = OPENER_PORT_INDICATOR_STATE_STEADY_OFF,
    },
    [kDeviceStatusSelfTesting] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_FLASHING,
        .red = OPENER_PORT_INDICATOR_STATE_FLASHING,
    },
    ...
    [kDeviceStatusSelfTestException] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_STEADY_OFF,
        .red = OPENER_PORT_INDICATOR_STATE_FLASHING,
    },
    [kDeviceStatusExecuting] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_STEADY_ON,
        .red = OPENER_PORT_INDICATOR_STATE_STEADY_OFF,
    },
    ...
    [kDeviceStatusCriticalFault] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_STEADY_OFF,
        .red = OPENER_PORT_INDICATOR_STATE_STEADY_ON,
    },
    [kDeviceStatusConfiguring] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_FLASHING,
        .red = OPENER_PORT_INDICATOR_STATE_FLASHING,
    },
    [kDeviceStatusWaitingforTUNID] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_FLASHING,
        .red = OPENER_PORT_INDICATOR_STATE_FLASHING,
    }
...
#if defined(OPENER_CIP_SAFETY)
    [OPENER_PORT_NETWORK_STATE_WAIT_FOR_TUNID] =
    {
        .green = OPENER_PORT_INDICATOR_STATE_FAST_FLASHING,
        .red = OPENER_PORT_INDICATOR_STATE_FAST_FLASHING
    },
#endif
...
/*******************************************************************************************************************//**
 * @brief Get a current module state.
 *
 * @retval USR_SUCCESS                  Process has been done successfully.
 **********************************************************************************************************************/
usr_err_t um_opener_port_task_indicator_get_module_state( opener_port_indicator_ctrl_t * const p_ctrl,
                                                          opener_port_module_state_t * const p_module_state )
{
    /** Error code */
    usr_err_t usr_err = USR_ERR_ABORTED;

    /** Return module status */
    * p_module_state = p_ctrl->module_state;
...
static void _task_code (void * pvParameter)
{
    ...
    opener_port_indicator_ctrl_t * const p_ctrl = (opener_port_indicator_ctrl_t *) pvParameter;

    /** Error status */
    usr_err_t usr_err;
#if defined(OPENER_CIP_SAFETY)
    CipUsint device_status = kDeviceStatusUndefined;
#endif
...
#if defined(OPENER_CIP_SAFETY)
        device_status = CipSafetySupervisorGetDeviceStatus();
        usr_err = um_opener_port_callback_request( p_ctrl->p_callback_ctrl,
                                                   OPENER_PORT_CALLBACK_CHANGE_MODULE_STATUS_LED,
                                                   g_module_state_safety_indicator_map[device_status] );
        if ( USR_SUCCESS != usr_err )
        {
            /** Error handling */
        }
...
#if defined(OPENER_CIP_SAFETY)
        case OPENER_PORT_NETWORK_STATE_WAIT_FOR_TUNID:               /* Waiting for TUNID when Proposed TUNID recieved */
#endif
            return USR_SUCCESS;
            break;
        default:
...
#if defined(OPENER_CIP_SAFETY)
    case OPENER_PORT_NETWORK_STATE_WAIT_FOR_TUNID:
        return USR_SUCCESS;
        break;
#endif
