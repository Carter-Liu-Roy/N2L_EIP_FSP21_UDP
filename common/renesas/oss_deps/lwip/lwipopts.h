...
/**
 * Disable POSIX-style sockets functions names
 */
...
#endif
#define LWIP_SNMP_APP              LWIP_SNMP

//#define SNMP_LWIP_MIB2_SYSDESC              "sysDescr not set"
#define SNMP_LWIP_MIB2_SYSDESC              "Renesas Electronics Corporation EtherNet/IP Sample"
#define SNMP_LWIP_MIB2_SYSCONTACT           "sysContact not set"
#define SNMP_LWIP_MIB2_SYSNAME              "sysName not set"
#define SNMP_LWIP_MIB2_SYSLOCATION          "sysLocation not set"

#define LWIP_LLDP               1

#define LWIP_LLDP_CIP_CONNECTED 1

#define LWIP_EIP_ACD            1

#define LWIP_NETIF_ACD_CALLBACK 1
