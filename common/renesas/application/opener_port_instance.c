 ...
 */
#define SAMPLE_STATIC_IP_ADDRESS        PP_HTONL(LWIP_MAKEU32(192,168,  1,  10)) ///< TCP/IP interface object attribute: interface configuration (#5)
...
#define SAMPLE_STATIC_GATEWAY_ADDRESS   PP_HTONL(LWIP_MAKEU32(192,168,  1,   2)) ///< TCP/IP interface object attribute: interface configuration (#5)
...
static opener_port_cip_safetysupervisor_nvdata_t g_opener_port0_cip_safetysupervisor_nvdata =
{
         /* Password */
...
#if defined(OPENER_CIP_SAFETY)
         .p_safetysupervisor_nvdata = &g_opener_port0_cip_safetysupervisor_nvdata,
#endif
};
