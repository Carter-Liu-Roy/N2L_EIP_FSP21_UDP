...
#if 1 /* Renesas EIP Sample : Fixed because it differs from the specifications Volume 1: Common Industrial Protocol Specification C-1.4.3 Network Segment */
#define NETWORK_SEGMENT_SAFETY 0x10 /**< Message value indicating a network segment safety message */
#define NETWORK_SEGMENT_PRODUCTION_INHIBIT_TIME_IN_MICROSECONDS 0x11 /**< Message value indicating a network segment PIT in microseconds message */
#else
